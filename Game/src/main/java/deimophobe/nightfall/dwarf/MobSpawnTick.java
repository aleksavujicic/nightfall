...
public interface MobSpawnTick {
	...
	ImmutableList<MobSpawnTick> TICKS = ImmutableList.of(
			...
			new SimpleMobSpawnTick(125, 300, 300, PoisonType.MOBSPAWN),
			new SimpleMobSpawnTick(150, 500, 1000, PoisonType.MOBSPAWN),
			new SimpleMobSpawnTick(200, 1000, 2000, PoisonType.MOBSPAWN),
			KILL
	);
}
