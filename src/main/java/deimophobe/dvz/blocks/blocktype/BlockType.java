...
public class BlockType {
	...
	public static final ComparableBlock UNENCHANTED_WALL = new BlockSet(NORMAL_WALL, CRACKED_WALL, DAMAGED_WALL, BROKEN_WALL, new MaterialBlock(Material.SMOOTH_BRICK));
