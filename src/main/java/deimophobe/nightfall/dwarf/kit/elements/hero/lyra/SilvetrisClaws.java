package deimophobe.nightfall.dwarf.kit.elements.hero.lyra;
 ...
 */
public class SilvetrisClaws extends AbstractItem implements KitCooldownElement {
	
	public SilvetrisClaws(Dwarf dwarf) { super(dwarf); }
	
	private final ComplexCooldown leapCD = new ComplexCooldown(1, this::leap);
