 ...
 */
abstract class AbstractRuneblade extends AbstractItem implements KitCooldownElement {
	...
	AbstractRuneblade(Dwarf dwarf, int maxCD, ProcType regProc, ProcType dashProc) {
		super(dwarf);
