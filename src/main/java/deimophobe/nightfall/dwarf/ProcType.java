...
public enum ProcType {
	REGULAR		(60, 1, 3, 0, true, true, true),
	DRAGONSKIN	(100, 1, 4, 0, true, true, true),
	GRAVEL_PROC	(60, 1, 5, 0, true, true, true),
	EBOW		(60, 1, 2, 0, true, true, true),
	
	HORN		(160, 4, 4, 3, true, true, true),
	AVENGE		(160, 4, 4, 3, true, true, true),
	MALICE		(160, 2, 5, 0, true, true, true),
	SHRINE_FALL	(160, 2, 3, 3, false, false, true),
	
	RUNEDASH	(12, 1, 10, 0, false, false, false),
