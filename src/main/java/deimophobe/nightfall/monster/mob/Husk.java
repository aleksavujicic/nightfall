...
/**
 * Created by TKiwisi on 9/20/17.
 */
public class Husk extends AbstractMob {
    ...
    protected Husk(MonsterPlayer mons) {
        this(mons, null);
    }

    public Husk(MonsterPlayer mons, Location rebirth) {
        super(mons, MobType.ZOMBIE_HUSK);
